defmodule BlockScoutWeb.StakesController do
  ...
  defp withdraw_allowed?(delegator, epoch_number) do
    delegator.is_active and Decimal.positive?(delegator.max_withdraw_allowed)
      or delegator.is_active and Decimal.positive?(delegator.max_ordered_withdraw_allowed)
      or Decimal.positive?(delegator.ordered_withdraw) and delegator.ordered_withdraw_epoch < epoch_number
  end
end
